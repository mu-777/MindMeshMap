...
ハンドルをドラッグして空白にドロップして新規ノードを作る場合、新規ノード側でエッジを受けるハンドルと新規ノードができる位置は、引き伸ばし始めたハンドルで決まります。流れと逆向きのハンドル（右向きレイアウトなら左、下向きレイアウトなら上）から引き伸ばしたときは、新規ノードの流れ方向側のハンドル（右向きなら右、下向きなら下）で受け、ドロップした位置が新規ノードのその面（右向きなら右端、下向きなら下端）になります。それ以外のハンドルから引き伸ばしたときは、新規ノードの流れと逆向き側のハンドル（右向きなら左、下向きなら上）で受け、ドロップした位置が新規ノードの左上になります。どちらの場合も、ドロップした位置からエッジを引き伸ばした向きへノードが伸びます。
